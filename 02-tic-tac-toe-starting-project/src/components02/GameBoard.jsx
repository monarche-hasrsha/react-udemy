...
export default function GameBoard({ onSelectSquare, turns }) {
 ...
 // const [gameBoard, setGameBoard] = useState(initialGameBoard);/* here we created a useState with the intial 
  //value as the initalGamebord  */
...
we output the player symbol dynamically */ 
             ...
             is then actually passed as a value to onClick so that we have full control over how handleSelectSquare 
             will then be called when it is being called */
            ))}
            </ol>
          </li>
        ))}
